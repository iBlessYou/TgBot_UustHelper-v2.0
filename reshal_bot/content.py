...
text_application = ("📌Здесь вам необходимо создать заявку о предоставлении услуг по конкретным предметам и конкретным типам работы "
"(Тесты СДО, лабораторные и прочее)")

text_application_kurs = ("📌Нажмите на курс, чтобы перейти к выбору предметов")
...
text_application_subject = ("📌Нажмите на предмет, чтобы перейти к выбору работ для этого предмета")

text_application_work = ("📌Выберите работы по данному предмету. Можно выбрать несколько")
